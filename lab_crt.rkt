...
;;________________________________________Problem 1_____________________________________________ (DONE)
...
;;________________________________________Problem 2_____________________________________________ (DONE)
...
(define (M tuplelist)
  (if (null? tuplelist)
      1
      (* (list-ref (car tuplelist) 1) (M (cdr tuplelist)))
  )
)

;;________________________________________Problem 3_____________________________________________ (DONE)
...
(define (CRT-exists? tuplelist)
  (if (null? tuplelist)
      #t
      (CRTexists_Helper1 tuplelist 1)
  )
)

(define (CRTexists_Helper1 tuplelist x)
  (if (null? tuplelist)
      #t
      (if (< x (length tuplelist))
          (if (= (EuclidAlgo (list-ref (car tuplelist) 1) (list-ref (list-ref tuplelist x) 1)) 1)
              (CRTexists_Helper1 tuplelist (+ x 1) )
              (trueOrFalse #f)
          )
          (CRTexists_Helper2 (cdr tuplelist) #t)
      )
  )
)

(define (CRTexists_Helper2 tuplelist continueBoolean)
  (if (not continueBoolean)
      #f
      (CRTexists_Helper1 tuplelist 1)
  )
)
...
;;________________________________________Problem 4_____________________________________________ (DONE)
...
(define (CRT-helper tuplelist m)
  (if (null? tuplelist)
      0
      (CRT-helper-helper tuplelist m 0)
  )
)

(define (CRT-helper-helper tuplelist m i)
  (if (null? tuplelist)
      0
      (+ (* (list-ref (car tuplelist) 0) (/ m (list-ref (car tuplelist) 1)) (mul_inv (/ m (list-ref (car tuplelist) 1)) (list-ref (car tuplelist) 1))) (CRT-helper-helper (cdr tuplelist) m (+ i 1)))
  )
)

;;________________________________________Problem 5_____________________________________________ (DONE)
